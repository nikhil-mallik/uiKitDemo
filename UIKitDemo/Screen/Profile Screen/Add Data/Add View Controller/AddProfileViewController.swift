...
class AddProfileViewController: UIViewController {
    ...
    let viewModel = ProfileAddViewModel()
...
extension AddProfileViewController {
    ...
    func navigateToFetchScreen() {
        let profileDetailVC = FetchProfileTableViewController.sharedIntance()
        profileDetailVC.profileData = profileInfo
    ...
    func navigateToFetchScreenAfterEditing() {
        // Update profile and navigate to fetch screen
        let profileDetailVC = FetchProfileTableViewController.sharedIntance()
        profileDetailVC.profileData = profileInfo
        navigationController?.pushViewController(profileDetailVC, animated: true)
        
        // Remove AddProfileViewController from navigation stack
...
extension AddProfileViewController {
    func fakeData() {
        ...
        let profile = ProfileModel(
            ...
            firstNames: "Lorem ipsum dolor sit er elit lamet,nikhilmallik@test@test@test@ test@ test",
            lastNames: "Lorem ipsum dolor sitnikhilmallik@test@test@test@ test@ test",
            email: "nikhilmallik@test@test@test@ test@ testnikhilmallik@test@test@test@ test@ test",
            mobileNumbers: "123456789012345678901234567890123456789012345678901234567890",
